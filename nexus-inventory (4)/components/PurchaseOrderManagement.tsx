       ...
       <div id="po-pdf-template" className="hidden bg-white text-black font-sans relative" style={{ width: '8.5in', height: '11in' }}>
          {pdfPO && (
              <>
                ...
                {/* 6: Signature Section - Adjusted Downward A Bit Further per request */}
                {/* Prepared By moved to Y = 8.80 (Line) */}
                <div style={{ position: 'absolute', left: '0.75in', top: '8.55in', width: '2.8in', textAlign: 'center', fontSize: '11.5pt', fontWeight: 'bold' }}>
                    {pdfPO.preparedBy.toUpperCase()}
                </div>
                <div style={{ position: 'absolute', left: '0.75in', top: '8.80in', width: '2.8in', borderBottom: '1.2pt solid #000' }}></div>
                <div style={{ position: 'absolute', left: '0.75in', top: '8.85in', width: '2.8in', textAlign: 'center', fontSize: '8.5pt', fontWeight: 'bold', color: '#64748b' }}>
                    PREPARED BY
                </div>

                {/* Noted By moved to Y = 9.70 (Line) */}
                <div style={{ position: 'absolute', left: '0.75in', top: '9.45in', width: '2.8in', textAlign: 'center', fontSize: '11.5pt', fontWeight: 'bold' }}>
                    {pdfPO.notedBy.toUpperCase()}
                </div>
                <div style={{ position: 'absolute', left: '0.75in', top: '9.70in', width: '2.8in', borderBottom: '1.2pt solid #000' }}></div>
                <div style={{ position: 'absolute', left: '0.75in', top: '9.75in', width: '2.8in', textAlign: 'center', fontSize: '8.5pt', fontWeight: 'bold', color: '#64748b' }}>
                    NOTED BY
                </div>
              </>
          )}
